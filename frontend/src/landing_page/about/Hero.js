    ...
    return (
        <div className='container'>
            <div className='row p-5 mb-5 mt-5'>
                <h1 className='text-center fs-2' style={{ color: "#424242" }}>We pioneered the discount broking model in India.<br />Now, we are breaking ground with our technology.</h1>
            </div>
            <div className='row p-5 mt-5 border-top' style={{ color: "#424242" }}>
                <div className='col-1'></div>
                <div className='col-5' style={{ lineHeight: "1.8", }}>
